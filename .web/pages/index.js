...
export function Button_2cc2be983b3bf416041af7e947c56021 () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);


  const on_click_dda290571dddfe19339461ff4bd964fa = useCallback(((...args) => (addEvents([(Event("reflex___state____state.blog_rflex___states____state.blog_rflex___states____login_state.blog_rflex___states____authentication.user_login", ({  }), ({  })))], args, ({  })))), [addEvents, Event])


  return (
    <RadixThemesButton color={"green"} css={({ ["width"] : "100%" })} onClick={on_click_dda290571dddfe19339461ff4bd964fa}>
...
export function Debounceinput_9114b056860d2fe3689680bb38a6f7df () {
  const reflex___state____state__blog_rflex___states____state__blog_rflex___states____login_state = useContext(StateContexts.reflex___state____state__blog_rflex___states____state__blog_rflex___states____login_state)
  const [addEvents, connectErrors] = useContext(EventLoopContext);


  const on_change_6199a3de7a687f4a708bdb5b162fa956 = useCallback(((_e) => (addEvents([(Event("reflex___state____state.blog_rflex___states____state.blog_rflex___states____login_state.update_email", ({ ["email"] : _e["target"]["value"] }), ({  })))], [_e], ({  })))), [addEvents, Event])


  return (
    <DebounceInput css={({ ["width"] : "100%" })} debounceTimeout={300} element={RadixThemesTextField.Root} onChange={on_change_6199a3de7a687f4a708bdb5b162fa956} type={"text"} value={reflex___state____state__blog_rflex___states____state__blog_rflex___states____login_state.email}/>
  )
}
...
export function Errorboundary_2bd367338016cf88816dc87f7304d9c4 () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);
...
{"Sig In below to access your account."}
</RadixThemesText>
...
<Debounceinput_9114b056860d2fe3689680bb38a6f7df/>
</RadixThemesFlex>
<RadixThemesFlex align={"start"} className={"rx-Stack"} css={({ ["@media screen and (min-width: 0)"] : ({ ["width"] : "100%", ["padding"] : "0rem 2rem" }), ["@media screen and (min-width: 30em)"] : ({ ["width"] : "100%" }), ["@media screen and (min-width: 48em)"] : ({ ["width"] : "70%" }), ["@media screen and (min-width: 62em)"] : ({ ["width"] : "50%" }), ["@media screen and (min-width: 80em)"] : ({ ["width"] : "35%" }), ["transition"] : "all 550ms ease", ["display"] : "flex", ["justifyContent"] : "center", ["alignItems"] : "start" })} direction={"column"} gap={"2"}>
...
<Debounceinput_9b932d826f3b3cc2b7a77f9d1c7edeee/>
</RadixThemesFlex>
<RadixThemesFlex align={"start"} className={"rx-Stack"} css={({ ["@media screen and (min-width: 0)"] : ({ ["width"] : "100%", ["padding"] : "0rem 2rem" }), ["@media screen and (min-width: 30em)"] : ({ ["width"] : "100%" }), ["@media screen and (min-width: 48em)"] : ({ ["width"] : "70%" }), ["@media screen and (min-width: 62em)"] : ({ ["width"] : "50%" }), ["@media screen and (min-width: 80em)"] : ({ ["width"] : "35%" }), ["transition"] : "all 550ms ease", ["display"] : "flex", ["justifyContent"] : "center", ["alignItems"] : "start", ["height"] : "45px" })} direction={"row"} gap={"3"}>

<Button_2cc2be983b3bf416041af7e947c56021/>
</RadixThemesFlex>
<RadixThemesFlex css={({ ["flex"] : 1, ["justifySelf"] : "stretch", ["alignSelf"] : "stretch" })}/>
<RadixThemesFlex css={({ ["flex"] : 1, ["justifySelf"] : "stretch", ["alignSelf"] : "stretch" })}/>
<RadixThemesText as={"p"}>
...
export function Debounceinput_9b932d826f3b3cc2b7a77f9d1c7edeee () {
  const reflex___state____state__blog_rflex___states____state__blog_rflex___states____login_state = useContext(StateContexts.reflex___state____state__blog_rflex___states____state__blog_rflex___states____login_state)
  const [addEvents, connectErrors] = useContext(EventLoopContext);


  const on_change_0d3e299cf90c92051bf0dda4da37ed63 = useCallback(((_e) => (addEvents([(Event("reflex___state____state.blog_rflex___states____state.blog_rflex___states____login_state.update_password", ({ ["password"] : _e["target"]["value"] }), ({  })))], [_e], ({  })))), [addEvents, Event])


  return (
    <DebounceInput css={({ ["width"] : "100%" })} debounceTimeout={300} element={RadixThemesTextField.Root} onChange={on_change_0d3e299cf90c92051bf0dda4da37ed63} type={"password"} value={reflex___state____state__blog_rflex___states____state__blog_rflex___states____login_state.password}/>
  )
}
...
export default function Component() {
  ...
  return (
    <Errorboundary_2bd367338016cf88816dc87f7304d9c4/>
  )
}
